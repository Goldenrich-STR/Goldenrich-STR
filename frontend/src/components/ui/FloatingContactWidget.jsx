...
export default function FloatingContactWidget() {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-center space-y-3.5 print:hidden">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#18181b] hover:bg-[#09090b] text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 border border-white/10"
      >
