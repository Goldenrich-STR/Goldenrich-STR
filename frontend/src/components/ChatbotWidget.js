...
5. **Go Live:** Your listing receives the verified green trust badge and is visible in the search browse index!`,
    ...
    hostText: `Listing a property on **X-Space360** is simple and rewarding! Here is the summary:
...
* **✉️ Email:** support@x-space360.com
...
💡 **MAYUR's Analysis:** The core platform functions perfectly. There are no critical errors. All database seeds, login auths, and payment verification gates are running at 100% capacity.`,
    ...
    fallbackText: "I'm MAYUR, your X-Space360 helper. I can troubleshoot system issues, explain onboarding steps, verification procedures, or payouts. Choose one of the quick options below or ask directly!"
  },
  hi: {
...
5. **लाइव जाएं:** आपकी संपत्ति को "भौतिक सत्यापन उत्तीर्ण" बैज मिलेगा और यह लाइव हो जाएगी!`,
    ...
    hostText: `एक्स-स्पेस३६० (X-Space360) पर संपत्ति सूचीबद्ध करना बहुत आसान है:
...
💡 **MAYUR का विश्लेषण:** वेबसाइट पूरी तरह से सुरक्षित और स्थिर है। डेटाबेस, प्रमाणीकरण और भुगतान गेटवे पूरी क्षमता से काम कर रहे हैं।`,
    ...
    fallbackText: "मैं MAYUR हूँ, आपका एक्स-स्पेस३६० (X-Space360) सहायक। मैं सिस्टम समस्याओं को हल करने, ऑनबोर्डिंग चरणों और भुगतानों को समझाने में आपकी मदद कर सकता हूँ। नीचे दिए गए विकल्पों में से चुनें या सीधे पूछें!"
  },
  mr: {
...
5. **जागा लाईव्ह करा:** व्हेरिफिकेशन पूर्ण होताच तुमच्या जागेला "Physical Verification Passed" चा शिक्का मिळेल आणि बुकिंग सुरू होईल!`,
    ...
    hostText: `एक्स-स्पेस३६० (X-Space360) वर जागा लिस्ट करणे सोपे आणि फायदेशीर आहे:
...
2. X-Space360 records the booking payment.
