...
class NotificationType(str, Enum):
    ...
    GUEST_BOOKING_CANCELLED = "guest_booking_cancelled"
    HOST_BOOKING_CANCELLED = "host_booking_cancelled"
    BOOKING_INVOICE = "booking_invoice"
    GUEST_CHECKOUT_REMINDER = "guest_checkout_reminder"
    GUEST_STAY_COMPLETED = "guest_stay_completed"
