    ...
    async def trigger_ai_booking_call(db: AsyncIOMotorDatabase, booking: dict) -> dict:
        ...
        try:
            ...
            if guest_phone:
                if language == "Hindi":
                    guest_script = (
                        f"{greeting}, {guest_name}! Main Golden Rich Stay AI Concierge bol raha hoon. "
                    ...
                    guest_script = (
                        f"{greeting}, {guest_name}! Me Golden Rich Stay AI Concierge bolat aahe. "
                    ...
                    guest_script = (
                        f"{greeting}, {guest_name}! This is the Golden Rich Stay AI Concierge calling to confirm "
            ...
            if host_phone:
                if language == "Hindi":
                    host_script = (
                        f"{greeting}, {host_name}! Main Golden Rich Stay AI Agent bol raha hoon. "
                    ...
                    host_script = (
                        f"{greeting}, {host_name}! Me Golden Rich Stay AI Agent bolat aahe. "
                    ...
                    host_script = (
                        f"{greeting}, {host_name}! This is the Golden Rich Stay AI Agent calling to inform you "
